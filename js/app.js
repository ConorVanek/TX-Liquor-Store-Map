...
var map = new L.Map('map', {center: center, zoom: 2, maxZoom: maxZoom, maxBounds: [[18.91619,-171.791110603],[71.3577635769,-66.96466]], layers: [basemap]});
map.doubleClickZoom.disable();

L.control.mousePosition().addTo(map);

var pinIcon = L.icon ({
	iconUrl: 'js/images/map-pin.png',
	iconSize: [41,41]
});
...
var imageUrl = 'img/txPopDensity.png';
var imageBounds = [[25.1652, -107.5781], [37.6490, -92.8125]];
...
map.on('dblclick', function(e) {
 ...
 newMarker = new L.marker(e.latlng, {icon: pinIcon}).addTo(map);
if (window.confirm('Lat, Lon : ' + e.latlng.lat + ', ' + e.latlng.lng + '\nClick "ok" to open this spot in Google')) 
{
var googlesearch = 'https://www.google.com/search?q=' + e.latlng.lat + ',+' + e.latlng.lng;
